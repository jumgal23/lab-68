...
class LikedItem(models.Model):
    likes = models.ManyToManyField(Like, related_name='liked_items', blank=True)

    def get_likes_count(self):
        return self.likes.count()


class ArticleLikedItem(LikedItem):
    article = models.OneToOneField('webapp.Article', related_name='liked_item', on_delete=models.CASCADE)


class CommentLikedItem(LikedItem):
    comment = models.OneToOneField('webapp.Comment', related_name='liked_item', on_delete=models.CASCADE)
